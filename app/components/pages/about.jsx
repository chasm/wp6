...
class AboutPage extends Component {
  ...
  render () {
    ...
    let pretext = this.state.pirate ?
      "The pirate speaks,\"grog, if you be seekin' t' truth, be better than a lie detector. It encourages a man t' be expansive, even reckless, while lie detectors be only a challenge t' tell lies successfully.\"" :
